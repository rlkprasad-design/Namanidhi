...
const STRINGS = {
  ...
  flagHintExplainer: {
    te: '🚩 ఏదైనా పదం లేదా దాని అర్థం సందేహాస్పదంగా అనిపిస్తే, పక్కన ఉన్న జెండా గుర్తును నొక్కి మాకు తెలియజేయండి.',
    en: '🚩 If a word or its meaning looks off, tap the flag next to it to let us know.',
    kn: '🚩 ಒಂದು ಪದ ಅಥವಾ ಅದರ ಅರ್ಥ ಸಂಶಯಾಸ್ಪದ ಎನಿಸಿದರೆ, ಪಕ್ಕದಲ್ಲಿರುವ ಧ್ವಜ ಚಿಹ್ನೆಯನ್ನು ಒತ್ತಿ ನಮಗೆ ತಿಳಿಸಿ.',
  },
  flagBtnTitle: { te: 'ఈ పదం/అర్థం సందేహాస్పదంగా అనిపిస్తే గుర్తు పెట్టండి', en: 'Flag this word/meaning as doubtful', kn: 'ಈ ಪದ/ಅರ್ಥ ಸಂಶಯಾಸ್ಪದವಾಗಿದ್ದರೆ ಗುರುತಿಸಿ' },
  flaggedConfirm: { te: 'గుర్తు పెట్టబడింది', en: 'Flagged', kn: 'ಗುರುತಿಸಲಾಗಿದೆ' },
  dismissFlagBtn: { te: 'పరిష్కరించబడింది', en: 'Resolved', kn: 'ಪರಿಹರಿಸಲಾಗಿದೆ' },
  flaggedQuestionsTitle: { te: 'సందేహాస్పదమైన ప్రశ్నలు', en: 'Questionable questions', kn: 'ಸಂಶಯಾಸ್ಪದ ಪ್ರಶ್ನೆಗಳು' },
  noFlaggedEntries: { te: 'ఇంకా ఏవీ గుర్తు పెట్టలేదు.', en: 'Nothing flagged yet.', kn: 'ಇನ್ನೂ ಏನನ್ನೂ ಗುರುತಿಸಿಲ್ಲ.' },
  colWord: { te: 'పదం', en: 'Word', kn: 'ಪದ' },
  colMeaning: { te: 'అర్థం', en: 'Meaning', kn: 'ಅರ್ಥ' },
  colSource: { te: 'ఎక్కడ నుండి', en: 'From', kn: 'ಎಲ್ಲಿಂದ' },
  colFlaggedBy: { te: 'ఎవరు గుర్తించారు', en: 'Flagged by', kn: 'ಯಾರು ಗುರುತಿಸಿದರು' },
